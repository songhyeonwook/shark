...
class BEVTransform:
    ...
    def project_lane2img(self, x_pred, y_pred_l, y_pred_r, y_mid):
...
def draw_lane_img(img, leftx, lefty, rightx, righty, xym, yym):
...
class purePursuit :
    ...
    def steering_angle(self):
        ...
        if self.is_look_forward_point :
            ...
            #steering_deg= 0
            steering_deg=np.arctan2(2*self.vehicle_length*np.sin(theta), self.lfd)
